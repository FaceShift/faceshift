...
function blinked(v1, v2) {
  //Values to be returned
  var leftBlinkOccurred = false;
  var rightBlinkOccurred = false;
  ...
  var leftBlinkRatio = Math.abs(yLE / yN);
  var rightBlinkRatio = Math.abs(yRE / yN);
  var ratioLimit = 10; //Ratio must be atleast this to be considered a blink
  var pxLimit = 1;   //Avg pixel movement must be atleast this to be considered a blink
